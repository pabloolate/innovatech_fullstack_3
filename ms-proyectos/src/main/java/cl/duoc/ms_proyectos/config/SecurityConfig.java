package cl.duoc.ms_proyectos.config;

import cl.duoc.ms_proyectos.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain configurarSeguridad(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/participantes-proyecto/**").hasAnyRole("ADMIN", "USER")
